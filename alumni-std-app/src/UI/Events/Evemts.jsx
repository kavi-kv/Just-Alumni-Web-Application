...
export default function Events(props) {
  ...
  return (
    ...
    <Container sx={{mt: 4}}>
        <Typography variant='h6' sx={{color: "gray",fontSize: 28}}>Upcoming Events</Typography>
        {
            ...
            <div className='event_title'>
               ...
               <span className='flex_row'><CalendarMonthIcon fontSize='small' sx={{mr: 1}}/> {value.started}</span>
                <span className='flex_row'><NavigationIcon fontSize='small' sx={{mr: 1}}/>{value.Location}</span>
                <span className='flex_row'><GroupIcon sx={{mr: 1}}/> {value.Participate}</span>
               </div>
               <Divider/>
